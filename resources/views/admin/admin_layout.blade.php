...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>XIXOTECH</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="" class="nav-link">Today's Order</a></li>
           <li class="nav-item"><a href="" class="nav-link">Today's Delivery</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="" class="nav-link">New Orders</a></li>
          <li class="nav-item"><a href="" class="nav-link">Accept Payment</a></li>
           <li class="nav-item"><a href="" class="nav-link">Cancle Order</a></li>
            <li class="nav-item"><a href="" class="nav-link">Process Order</a></li>
             <li class="nav-item"><a href="" class="nav-link">Delivered Orders</a></li>
